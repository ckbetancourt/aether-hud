...
async function reclaimTask(board, taskId, body = {}) {
  return invokeKanbanBridge('reclaim_task', withBoard(board, { task_id: taskId, body }));
}

async function reassignTask(board, taskId, body = {}) {
  return invokeKanbanBridge('reassign_task', withBoard(board, { task_id: taskId, body }));
}
